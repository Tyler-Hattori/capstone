...
cv2.imwrite(file_name, bw_img)
cv2.waitKey(0)

print("You will need to define the real world scale of the map")
print("Double click a point on the map")
#
# Read in the image
#
...
#
    if x1[0] == 0:
      x1[0]=ix
      y1[0]=iy
      print('Double click a second point on the map on the same x axis as the first')   
      ...
      sx = deltax / dx
      print('Now double click another point')
    elif (x1[1] != 0 and x1[2] == 0):
      x1[2]=ix
      y1[2]=iy
      print('Double click a second point on the same y axis')
    else:
      prompt = '> '
