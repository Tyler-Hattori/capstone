                ...
                rate_(50.0)
{
    ...
    publisher_ = node_handle_.advertise<pixy2_msgs::PixyData>("/bucket_visual", queue_size);
    constantsPublisher_ = node_handle_.advertise<pixy2_msgs::PixyResolution>("/pixy_resolution", 5, true);
