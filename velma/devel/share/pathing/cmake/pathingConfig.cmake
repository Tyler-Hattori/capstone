...
if("TRUE" STREQUAL "TRUE")
  set(pathing_SOURCE_PREFIX /home/ubuntu/F1Tenth/velma/src/pathing)
  set(pathing_DEVEL_PREFIX /home/ubuntu/F1Tenth/velma/devel)
  set(pathing_INSTALL_PREFIX "")
  set(pathing_PREFIX ${pathing_DEVEL_PREFIX})
else()
  set(pathing_SOURCE_PREFIX "")
  set(pathing_DEVEL_PREFIX "")
  set(pathing_INSTALL_PREFIX /home/ubuntu/F1Tenth/velma/install)
...
if(NOT "/home/ubuntu/F1Tenth/velma/devel/include;/home/ubuntu/F1Tenth/velma/src/pathing/include " STREQUAL " ")
  set(pathing_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/F1Tenth/velma/devel/include;/home/ubuntu/F1Tenth/velma/src/pathing/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pathing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/F1Tenth/velma/src/pathing/${idir}'.  ${_report}")
    endif()
