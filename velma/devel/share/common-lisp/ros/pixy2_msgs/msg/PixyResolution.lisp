...
(cl:defmethod cl:initialize-instance :after ((m <PixyResolution>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PixyResolution)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pixy2_msgs-msg:<PixyResolution> is deprecated: use pixy2_msgs-msg:PixyResolution instead.")))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <PixyResolution>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pixy2_msgs-msg:width-val is deprecated.  Use pixy2_msgs-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <PixyResolution>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pixy2_msgs-msg:height-val is deprecated.  Use pixy2_msgs-msg:height instead.")
  (height m))
