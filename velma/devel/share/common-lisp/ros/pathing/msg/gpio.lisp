...
(cl:defmethod cl:initialize-instance :after ((m <gpio>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'gpio)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pathing-msg:<gpio> is deprecated: use pathing-msg:gpio instead.")))
