...
(cl:defmethod cl:initialize-instance :after ((m <gpiowrite>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'gpiowrite)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name led_control-msg:<gpiowrite> is deprecated: use led_control-msg:gpiowrite instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <gpiowrite>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader led_control-msg:state-val is deprecated.  Use led_control-msg:state instead.")
  (state m))

(cl:ensure-generic-function 'duration-val :lambda-list '(m))
(cl:defmethod duration-val ((m <gpiowrite>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader led_control-msg:duration-val is deprecated.  Use led_control-msg:duration instead.")
  (duration m))
