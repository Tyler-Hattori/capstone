...
echo_and_run cd "/home/ubuntu/F1Tenth/velma/src/twist_to_ackermann"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu/F1Tenth/velma/src/twist_to_ackermann/setup.py" \
     \
    build --build-base "/home/ubuntu/F1Tenth/velma/build/twist_to_ackermann" \
    install \
    --root="${DESTDIR-/}" \
