...
echo_and_run cd "/home/thattori/capstone/F1Tenth/velma/src/gpio"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/thattori/capstone/F1Tenth/velma/src/gpio/setup.py" \
     \
    build --build-base "/home/thattori/capstone/F1Tenth/velma/build/gpio" \
    install \
    --root="${DESTDIR-/}" \
