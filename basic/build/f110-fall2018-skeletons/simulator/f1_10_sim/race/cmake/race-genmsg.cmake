...
set(MSG_I_FLAGS "-Irace:/home/ubuntu/f1tenth/basic/src/f110-fall2018-skeletons/simulator/f1_10_sim/race/msg;-Isensor_msgs:/opt/ros/noetic/share/sensor_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ubuntu/f1tenth/basic/src/f110-fall2018-skeletons/simulator/f1_10_sim/race/msg/drive_param.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/ubuntu/f1tenth/basic/src/f110-fall2018-skeletons/simulator/f1_10_sim/race/msg/drive_param.msg" ""
)

get_filename_component(_filename "/home/ubuntu/f1tenth/basic/src/f110-fall2018-skeletons/simulator/f1_10_sim/race/msg/drive_values.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/ubuntu/f1tenth/basic/src/f110-fall2018-skeletons/simulator/f1_10_sim/race/msg/drive_values.msg" ""
)

get_filename_component(_filename "/home/ubuntu/f1tenth/basic/src/f110-fall2018-skeletons/simulator/f1_10_sim/race/msg/pid_input.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/ubuntu/f1tenth/basic/src/f110-fall2018-skeletons/simulator/f1_10_sim/race/msg/pid_input.msg" ""
)
...
_generate_msg_cpp(race
  "/home/ubuntu/f1tenth/basic/src/f110-fall2018-skeletons/simulator/f1_10_sim/race/msg/drive_param.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/race
)
_generate_msg_cpp(race
  "/home/ubuntu/f1tenth/basic/src/f110-fall2018-skeletons/simulator/f1_10_sim/race/msg/drive_values.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/race
)
_generate_msg_cpp(race
  "/home/ubuntu/f1tenth/basic/src/f110-fall2018-skeletons/simulator/f1_10_sim/race/msg/pid_input.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/race
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/race)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/race\")")
  # install generated code
  install(
